...
-- CREATE PROCEDURE dbo.usp_MoveParentTestCaseWithChildren
...
-- -- Get the current position and FeatureID of the parent TestCase
-- SELECT @OldPosition = [Offset], @FeatureID = FeatureID
-- FROM main.dbo.TestCases
-- WHERE TestCaseID = @ParentTestCaseID;

-- -- Get the count of child TestCases
-- SELECT @ChildrenCount = COUNT(*)
-- FROM main.dbo.TestCases
-- WHERE ParentTestCaseID = @ParentTestCaseID;

-- -- Move the parent TestCase and its children to the new position
-- IF @NewPosition < @OldPosition
-- BEGIN
-- 	-- Shift the TestCases between the new position and the old position to the right
-- 	UPDATE main.dbo.TestCases
-- 	SET [Offset] = [Offset] + (@ChildrenCount + 1)
-- 	WHERE FeatureID = @FeatureID
-- 	AND [Offset] >= @NewPosition
-- 	AND [Offset] < @OldPosition;

-- 	-- Move the parent TestCase and its children to the new position
-- 	UPDATE main.dbo.TestCases
-- 	SET [Offset] = [Offset] - (@OldPosition - @NewPosition)
-- 	WHERE FeatureID = @FeatureID
-- 	AND ([Offset] > @OldPosition AND [Offset] <= @OldPosition + @ChildrenCount)
-- 	OR TestCaseID = @ParentTestCaseID;
-- END
-- ELSE IF @NewPosition > @OldPosition
-- BEGIN
-- 	-- Shift the TestCases between the old position and the new position to the left
-- 	UPDATE main.dbo.TestCases
-- 	SET [Offset] = [Offset] - (@ChildrenCount + 1)
-- 	WHERE FeatureID = @FeatureID
-- 	AND [Offset] <= @NewPosition
...
-- 	-- Move the parent TestCase and its children to the new position
-- 	UPDATE main.dbo.TestCases
-- 	SET [Offset] = [Offset] + (@NewPosition - @OldPosition)
-- 	WHERE FeatureID = @FeatureID
-- 	AND ([Offset] >= @OldPosition AND [Offset] < @OldPosition + @ChildrenCount)
-- 	OR TestCaseID = @ParentTestCaseID;
-- END
...
-- INSERT INTO main.dbo.companyUsers (companyId, userId)
-- VALUES (1, 1), (1, 2), (2, 3);

-- -- Insert into features
-- INSERT INTO main.dbo.features (name, companyId)
-- VALUES ('Feature 1', 1), ('Feature 2', 1), ('Feature 3', 2);

-- -- Insert into testCases
-- INSERT INTO main.dbo.testCases (featureId, name, sortOrder)
-- VALUES (1, 'Test Case 1', 1), (1, 'Test Case 2', 2), (2, 'Test Case 3', 1);

-- -- Insert into testResults
-- INSERT INTO main.dbo.testResults (featureId, resultsJson, userId, [date])
-- VALUES (1, N'{"result": "pass"}', 1, '2023-05-25');

-- -- Insert into testRuns
-- INSERT INTO main.dbo.testRuns (name, [date], userId, startTime, endTime, testRunStatus)
-- VALUES 
-- ('Test Run 1', '2023-05-25', 1, '2023-05-25 09:00:00', '2023-05-25 10:00:00', 1),
-- ('Test Run 2', '2023-05-25', 2, '2023-05-25 10:00:00', '2023-05-25 11:00:00', 2),
-- ('Test Run 3', '2023-05-25', 3, '2023-05-25 11:00:00', '2023-05-25 12:00:00', 3);

-- -- Insert into testRunCases
-- INSERT INTO main.dbo.testRunCases (testRunId, testCaseId, testCaseStatus, testCaseComment)
-- VALUES (1, 1, 1, 'Test case comment 1'), (1, 2, 2, 'Test case comment 2'), (2, 3, 3, 'Test case comment 3');
