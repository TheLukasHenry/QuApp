...
export interface FeaturesFeatureIdGetRequest {
    featureId: number;
}
...
export class FeaturesApi extends runtime.BaseAPI {
    ...
    /**
     */
    async featuresFeatureIdDeleteRaw(requestParameters: FeaturesFeatureIdDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.featureId === null || requestParameters.featureId === undefined) {
            throw new runtime.RequiredError('featureId','Required parameter requestParameters.featureId was null or undefined when calling featuresFeatureIdDelete.');
        }
        ...
        const response = await this.request({
            path: `/Features/{featureId}`.replace(`{${"featureId"}}`, encodeURIComponent(String(requestParameters.featureId))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    /**
     */
    async featuresFeatureIdDelete(requestParameters: FeaturesFeatureIdDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.featuresFeatureIdDeleteRaw(requestParameters, initOverrides);
    }

    /**
     */
    async featuresFeatureIdGetRaw(requestParameters: FeaturesFeatureIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Feature>> {
        if (requestParameters.featureId === null || requestParameters.featureId === undefined) {
            throw new runtime.RequiredError('featureId','Required parameter requestParameters.featureId was null or undefined when calling featuresFeatureIdGet.');
        }
    ...
    /**
     */
    async featuresFeatureIdGet(requestParameters: FeaturesFeatureIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Feature> {
        const response = await this.featuresFeatureIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
